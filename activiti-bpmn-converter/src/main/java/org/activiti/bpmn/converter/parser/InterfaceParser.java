...
public class InterfaceParser implements BpmnXMLConstants {
  ...
  public void parse(XMLStreamReader xtr, BpmnModel model) throws Exception {
    ...
    interfaceObject.setId(new StringBuilder().append(model.getTargetNamespace()).append(":").append(xtr.getAttributeValue(null, ATTRIBUTE_ID)).toString());
    ...
    try {
      while (!readyWithInterface && xtr.hasNext()) {
        ...
        if (xtr.isStartElement() && ELEMENT_OPERATION.equals(xtr.getLocalName())) {
          ...
          operation.setId(new StringBuilder().append(model.getTargetNamespace()).append(":").append(xtr.getAttributeValue(null, ATTRIBUTE_ID)).toString());
