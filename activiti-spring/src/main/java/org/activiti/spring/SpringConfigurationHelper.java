...
public class SpringConfigurationHelper {
  ...
  public static ProcessEngine buildProcessEngine(URL resource) {
    ...
    if ((beansOfType == null) || (beansOfType.isEmpty())) {
      throw new ActivitiException(new StringBuilder().append("no ").append(ProcessEngine.class.getName()).append(" defined in the application context ").append(resource.toString()).toString());
    }
