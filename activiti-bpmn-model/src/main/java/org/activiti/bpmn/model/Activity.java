...
public abstract class Activity extends FlowNode {
  ...
  public void setValues(Activity otherActivity) {
    ...
    if (otherActivity.getDataInputAssociations() != null && !otherActivity.getDataInputAssociations().isEmpty()) {
      otherActivity.getDataInputAssociations().forEach(association -> dataInputAssociations.add(association.clone()));
    }
    ...
    if (otherActivity.getDataOutputAssociations() != null && !otherActivity.getDataOutputAssociations().isEmpty()) {
      otherActivity.getDataOutputAssociations().forEach(association -> dataOutputAssociations.add(association.clone()));
    }
    
    boundaryEvents.clear();
    otherActivity.getBoundaryEvents().forEach(boundaryEvents::add);
  }
}
